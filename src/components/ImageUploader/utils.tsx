export const Spinner: React.FC = () => {
    return (
        <div role="status" className="flex flex-col relative items-center py-40 justify-center w-full h-full">
            <svg aria-hidden="true" className="w-8 h-8 mr-2 text-white animate-spin dark:text-gray-600 fill-primary-300" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
